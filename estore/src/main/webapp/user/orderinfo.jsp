...
<!--文件尾开始-->
		...
		<tr>
         ...
         <c:forEach items="${showOrderInfo}" var="orderlines">
		<tr>
			<td class=tablebody2 valign=middle align=center width="">${orderlines.book.id }</td>
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="" target="_blank">${orderlines.book.name }</a></td>
			<td class=tablebody2 valign=middle align=center width="">价格：${orderlines.book.price }</td>
			<td class=tablebody1 valign=middle align=center width="">数量：${orderlines.num}</td>
			<td class=tablebody2 valign=middle align=left width="">小计：￥${orderlines.num * orderlines.book.price }</td>
		</tr>
          </c:forEach>      
		<tr>
